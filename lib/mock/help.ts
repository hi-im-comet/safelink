...
export const HELP_CATEGORIES: HelpCategory[] = [
  {
    ...
    label: "응급 증상",
    tag: "응급 확인",
    items: ["어지러움·의식 저하·호흡 곤란이 있어요", "즉시 119 연락이 필요해요"],
  },
  {
    key: "call",
    label: "전화 확인 요청",
    tag: "전화 확인",
    items: ["오늘 전화 확인을 받고 싶어요", "상태 확인 연락이 필요해요"],
  },
  {
    key: "visit",
    label: "방문 확인 요청",
    tag: "방문 확인",
    items: ["방문 확인이 필요해요", "혼자 있어서 직접 확인이 필요해요"],
  },
  {
    key: "cooling",
    label: "냉방 지원 요청",
    tag: "냉방 지원",
    items: ["냉방비 지원 상담이 필요해요", "냉방용품 지원이 필요해요", "에어컨이 없거나 고장났어요", "선풍기만으로는 부족해요"],
  },
  {
    key: "shelter",
    label: "무더위쉼터 안내",
    tag: "쉼터 안내",
    items: ["가까운 무더위쉼터 위치를 알고 싶어요", "쉼터까지 이동이 어려워요", "이용 가능한 공공 실내공간을 알고 싶어요"],
  },
];
...
export const CAREGIVER_HELP_CATEGORIES: HelpCategory[] = [
  {
    ...
    label: "응급 확인 필요",
    tag: "응급 확인",
    items: ["어지러움·의식 저하·호흡 곤란이 의심돼요", "즉시 119 연락이 필요해 보여요"],
  },
  {
    key: "call",
    label: "전화 확인 요청",
    tag: "안부 확인",
    items: ["오늘 안부 전화 확인이 필요해요", "연락이 안 돼 상태 확인이 필요해요"],
  },
  {
    key: "visit",
    label: "방문 확인 요청",
    tag: "방문 검토",
    items: ["방문 확인이 필요해요", "혼자 계셔서 직접 확인이 필요해요", "보호자가 직접 가기 어려워요"],
  },
  {
    key: "cooling",
    label: "냉방 지원 요청",
    tag: "냉방 지원",
    items: ["냉방비 부담 때문에 에어컨을 참으실 수 있어요", "냉방용품 지원이 필요해 보여요", "에어컨이 없거나 고장난 것 같아요", "선풍기만으로는 부족해 보여요"],
  },
  {
    key: "shelter",
    label: "무더위쉼터 안내",
    tag: "쉼터 안내",
    items: ["가까운 무더위쉼터를 안내받고 싶어요", "쉼터까지 이동이 어려울 수 있어요", "이용 가능한 공공 실내공간을 알고 싶어요"],
  },
];
